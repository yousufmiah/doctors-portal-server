...
async function run() {
  try {
    ...
    app.get("/available", async (req, res) => {
      ...
      // step 2: get the booking that day output : [{},{},{},{}, {}]
     ...
     * app.get('/booking') //get all data bookings in this collections or more then one or by filter, query
     * app.get('/booking/:id')// get a specific booking or data by id
     * ===============
     * app.post('/booking') // add a new booking or data by create
     * app.patch('/booking/:id') // update a booking by id
     * app.put('/booking/:id') // like upsert == update (if exists) or insert (if does not exists)
